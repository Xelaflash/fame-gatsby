    ...
    <Layout>
      ...
      <Container>
        ...
        <p className="paragraphTexts">
          ...
          who felt in love with the island, the people and its culture.. <br />
          ...
          At the beginning it all started because of their love for the island,
          for the culture, and the international melting pot they found there
          and their love for the local Art. For the first edition they want to
          do an entire day and night, looking for the next editions to be
          longer.
        </p>
        <div className="founders_wrapper">
          {founders.map((founder, index) => (
            <div className="single-founder" key={index}>
              ...
              <BlockContent blocks={founder._rawDescriptionText} />
            </div>
          ))}
        </div>
      </Container>
